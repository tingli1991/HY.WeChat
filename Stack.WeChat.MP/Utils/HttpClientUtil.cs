...
namespace Stack.WeChat.MP.Utils
{
    ...
    public class HttpClientUtil
    {
        ...
        /// <param name="headers"></param>
        /// <returns></returns>
        public static T GetResponse<T>(string url, Dictionary<string, string> args = null, Dictionary<string, string> headers = null) where T : IMpResult, new()
        {
            T result = default;
            HttpResponseMessage httpResponseMessage = GetHttpResponseMessage(url, args, headers);
            if (!httpResponseMessage.IsSuccessStatusCode)
        ...
        /// <param name="headers"></param>
        /// <returns></returns>
        public static T PostResponse<T>(string url, string postData, Dictionary<string, string> headers = null) where T : IMpResult, new()
        {
            T result = default;
